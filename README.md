...
5. **Paiement RFID** : le second scan crée un popup de confirmation. Aucun débit n’a lieu avant le clic du caissier ; la confirmation revérifie le solde, débite et finalise la vente atomiquement.
