...
class LegacyApiSecurityTests(TestCase):
    def test_legacy_detection_route_rejects_an_unknown_device_id(self):
    ...
    def test_legacy_detection_requires_idempotency_key_without_a_secret(self):
        device = BasketDevice.objects.create(device_code="KITUNGA-PI-LEGACY", matrix_id=10)
        response = self.client.post(
